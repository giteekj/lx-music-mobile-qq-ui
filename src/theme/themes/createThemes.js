...
const defaultThemes = [
  ...
  },
  {
    ...
    isDark: false,
    config: {
      primary: 'rgb(0, 147, 221)',
      font: 'rgb(33, 33, 33)',
      'c-app-background': 'rgba(255, 255, 255, 0.15)',
      'c-main-background': 'rgba(255, 255, 255, 0.8)',
      'bg-image': 'doraemon_bg.png',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',
  ...
  },
  {
    ...
    isDark: false,
    config: {
      primary: 'rgb(30, 80, 162)',
      font: 'rgb(33, 33, 33)',
      'c-app-background': 'rgba(255, 255, 255, 0.15)',
      'c-main-background': 'rgba(255, 255, 255, 0.8)',
      'bg-image': 'conan_bg.png',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',
  ...
  },
  {
    ...
    isDark: false,
    config: {
      primary: 'rgb(235, 97, 115)',
      font: 'rgb(33, 33, 33)',
      'c-app-background': 'rgba(255, 255, 255, 0.15)',
      'c-main-background': 'rgba(255, 255, 255, 0.8)',
      'bg-image': 'maruko_bg.png',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',
